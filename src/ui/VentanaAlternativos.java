...
public class VentanaAlternativos extends JFrame {
	...
	private JLabel getLblAtencionParaEl() {
		if (lblAtencionParaEl == null) {
			lblAtencionParaEl = new JLabel(
					"ATENCION: Para el horario establecido");
		}
		...
		if (btAsignar == null) {
			...
			btAsignar.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					vam.getTextAreaVisualizar()
							.setText(vam.getTextAreaVisualizar().getText()
									+ " - " + asignado.toString() + "\n");
					vam.getVCC().getTaMedicos()
							.setText(vam.getVCC().getTaMedicos().getText()
									+ asignado.toString() + " ("
									+ asignado.getEspecialidad() + ")\n");
