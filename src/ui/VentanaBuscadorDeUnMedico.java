...
public class VentanaBuscadorDeUnMedico extends JFrame {
	...
	private VentanaConsultarJornadasYBajasPorMedicos vcjb;
	 ...
	 * Create the frame.
	 */
	public VentanaBuscadorDeUnMedico(
			VentanaConsultarJornadasYBajasPorMedicos vcjb) {
		this.vcjb = vcjb;
	 ...
	 * Create the frame.
	 */
	public VentanaBuscadorDeUnMedico(VentanaAñadirMedicos vam) {
		this.vam = vam;
		this.vcc = vam.getVCC();
		setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		setBounds(100, 100, 922, 595);
	 ...
	 */
	public VentanaBuscadorDeUnMedico(VentanaAsignarCalendarios vac) {
		this.vac = vac;
		setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		setBounds(100, 100, 922, 595);
		panel = new JPanel();
	...
	protected void añadir() {
		...
		vcjb.setMedico(gestorMedicos.buscarPorDni(d));
		ponerModeloAñadidos();
		vcjb.configurar();
		dispose();
	}
